        ...
        <>
            ...
            <div className="auth w-full flex justify-center items-center h-[70vh]">
                <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
                    <h1 className="auth_text text-xl font-bold text-left">Login to your account</h1>
                    ...
                    <button onClick={handleLogin} className="button w-full px-4 py-4 text-lg font-bold text-white">Login</button>
                    ...
                    <p className="demo">email: demo@gmail.com password: demo</p>
                </div>
            </div>
            <Footer />
        </>
