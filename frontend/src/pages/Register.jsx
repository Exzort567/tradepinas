    ...
    return (
        ...
        <div className="w-full flex justify-center items-center h-[70vh]">
            <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
                ...
                <input onChange={(e) => setUsername(e.target.value)} className="w-full px-4 py-2 border-2 border-black outerline-0" type="text" placeholder="Enter your username"/>
                ...
                <button onClick={handleRegister} className="w-full px-4 py-4 text-lg font-bold bg-black text-white rounded-lg hover:bg-gray-500 hover:text-black">Register</button>
